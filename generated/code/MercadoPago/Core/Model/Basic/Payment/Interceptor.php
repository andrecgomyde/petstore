...
class Interceptor extends \MercadoPago\Core\Model\Basic\Payment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'postPago');
        if (!$pluginInfo) {
            return parent::postPago();
        } else {
            return $this->___callPlugins('postPago', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getActionUrl');
        if (!$pluginInfo) {
            return parent::getActionUrl();
        } else {
            return $this->___callPlugins('getActionUrl', func_get_args(), $pluginInfo);
        }
    }
