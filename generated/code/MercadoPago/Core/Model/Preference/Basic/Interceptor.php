...
class Interceptor extends \MercadoPago\Core\Model\Preference\Basic implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'makePreference');
        if (!$pluginInfo) {
            return parent::makePreference();
        } else {
            return $this->___callPlugins('makePreference', func_get_args(), $pluginInfo);
        }
    }
