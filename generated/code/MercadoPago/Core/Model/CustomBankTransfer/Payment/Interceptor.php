<?php
namespace MercadoPago\Core\Model\CustomBankTransfer\Payment;

/**
 * Interceptor class for @see \MercadoPago\Core\Model\CustomBankTransfer\Payment
 */
class Interceptor extends \MercadoPago\Core\Model\CustomBankTransfer\Payment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'preparePostPayment');
        if (!$pluginInfo) {
            return parent::preparePostPayment($usingSecondCardInfo);
        } else {
            return $this->___callPlugins('preparePostPayment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPaymentOptions');
        if (!$pluginInfo) {
            return parent::getPaymentOptions();
        } else {
            return $this->___callPlugins('getPaymentOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdentifcationTypes');
        if (!$pluginInfo) {
            return parent::getIdentifcationTypes();
        } else {
            return $this->___callPlugins('getIdentifcationTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setOrderSubtotals($data)
    {
        ...
        if (!$pluginInfo) {
            return parent::setOrderSubtotals($data);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerAndCards');
        if (!$pluginInfo) {
            return parent::getCustomerAndCards();
        } else {
            return $this->___callPlugins('getCustomerAndCards', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'customerAndCards');
        if (!$pluginInfo) {
            return parent::customerAndCards($token, $payment_created);
        } else {
            return $this->___callPlugins('customerAndCards', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkAndcreateCard');
        if (!$pluginInfo) {
            return parent::checkAndcreateCard($customer, $token, $payment);
        } else {
            return $this->___callPlugins('checkAndcreateCard', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOrCreateCustomer');
        if (!$pluginInfo) {
            return parent::getOrCreateCustomer($email);
        } else {
            return $this->___callPlugins('getOrCreateCustomer', func_get_args(), $pluginInfo);
        }
    }
