...
class Interceptor extends \MercadoPago\Core\Model\Core implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getOrder');
        if (!$pluginInfo) {
            return parent::_getOrder($incrementId);
        } else {
            return $this->___callPlugins('_getOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInfoPaymentByOrder');
        if (!$pluginInfo) {
            return parent::getInfoPaymentByOrder($order_id);
        } else {
            return $this->___callPlugins('getInfoPaymentByOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessageByStatus');
        if (!$pluginInfo) {
            return parent::getMessageByStatus($status, $status_detail, $payment_method, $installment, $amount);
        } else {
            return $this->___callPlugins('getMessageByStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'makeDefaultPreferencePaymentV1');
        if (!$pluginInfo) {
            return parent::makeDefaultPreferencePaymentV1($paymentInfo, $quote, $order);
        } else {
            return $this->___callPlugins('makeDefaultPreferencePaymentV1', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'postPaymentV1');
        if (!$pluginInfo) {
            return parent::postPaymentV1($preference);
        } else {
            return $this->___callPlugins('postPaymentV1', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessageError');
        if (!$pluginInfo) {
            return parent::getMessageError($response);
        } else {
            return $this->___callPlugins('getMessageError', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPaymentV1');
        if (!$pluginInfo) {
            return parent::getPaymentV1($payment_id);
        } else {
            return $this->___callPlugins('getPaymentV1', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdentificationTypes');
        if (!$pluginInfo) {
            return parent::getIdentificationTypes();
        } else {
            return $this->___callPlugins('getIdentificationTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEmailCustomer');
        if (!$pluginInfo) {
            return parent::getEmailCustomer();
        } else {
            return $this->___callPlugins('getEmailCustomer', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validCoupon');
        if (!$pluginInfo) {
            return parent::validCoupon($coupon_id, $email);
        } else {
            return $this->___callPlugins('validCoupon', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMerchantOrder');
        if (!$pluginInfo) {
            return parent::getMerchantOrder($merchant_order_id);
        } else {
            return $this->___callPlugins('getMerchantOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPayment($payment_id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getPayment($payment_id);
        } else {
