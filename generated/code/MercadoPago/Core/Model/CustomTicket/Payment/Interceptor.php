...
class Interceptor extends \MercadoPago\Core\Model\CustomTicket\Payment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTicketsOptions');
        if (!$pluginInfo) {
            return parent::getTicketsOptions();
        } else {
            return $this->___callPlugins('getTicketsOptions', func_get_args(), $pluginInfo);
        }
    }
